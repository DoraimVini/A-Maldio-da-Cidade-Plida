...
| **Testes falhando** | `auto-qa-commit` | Corrigir a classe (POCO) responsável pela lógica testada, rodar os testes. Se passarem, fazer o commit. NUNCA prosseguir sem testes passando. |
