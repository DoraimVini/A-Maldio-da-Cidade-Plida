...
Funde a tela toda pra uma cor sólida (normalmente preto) e de volta — usado para mascarar teletransportes/eventos roteirizados sem precisar de um sistema de cutscene completo (ex.: a antiga queda Z4→Z5, hoje removida da dungeon). Sem regra de negócio: só interpola o alpha de uma `Image` full-stretch.
